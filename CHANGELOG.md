...
## [8.0.0](https://github.com/htool/canboat/compare/v8.1.0...v8.0.0) (2026-09-08)


### ⚠ BREAKING CHANGES

* **json:** default decoded output to camelCase ids and SI units ([#814](https://github.com/htool/canboat/issues/814))
...
* **126720:** add Fusion "Set Setting" (Proprietary ID 15) ([#867](https://github.com/htool/canboat/issues/867)) ([1765550](https://github.com/htool/canboat/commit/1765550d6d69679e057bf9c5b6eaab448f3be7b9))
* **126720:** restore shadowed variants and dedupe Maretron/BEP PGNs ([#744](https://github.com/htool/canboat/issues/744)) ([7796fba](https://github.com/htool/canboat/commit/7796fba0e861fc80f6cbe795c94d5b01326892ee))
* **127751:** decode DC Voltage/Current as single-frame, not fast packet ([2bce845](https://github.com/htool/canboat/commit/2bce845f0c874874db9044497c756fab6e5cedf7))
* **127751:** decode DC Voltage/Current as single-frame, not fast packet ([981883f](https://github.com/htool/canboat/commit/981883f0707b9a66966ab40b0a3f973529afa8d9)), closes [#829](https://github.com/htool/canboat/issues/829)
* **129540:** decode the reserved nibble as GNSS System ([#792](https://github.com/htool/canboat/issues/792)) ([08ea954](https://github.com/htool/canboat/commit/08ea954f4d8c782523d6353784db5ab66d0b5bc3))
* **130824:** decode B&G key-value roll/pitch/yaw rates ([#757](https://github.com/htool/canboat/issues/757)) ([8f737e9](https://github.com/htool/canboat/commit/8f737e93ba2a1dd8684d4bc267126c55173c3ee5))
* **130824:** decode Maretron annunciator status and its 126208 command path ([01cb810](https://github.com/htool/canboat/commit/01cb810ba557c1b381746ab6f400d43bda758eea))
* **130824:** decode Maretron annunciator status and its 126208 command path ([73aac89](https://github.com/htool/canboat/commit/73aac89cd10d58b6f7c46c9502871dd06e9f4616))
* **130827:** decode Furuno NavPilot status ([#742](https://github.com/htool/canboat/issues/742)) ([58a0f26](https://github.com/htool/canboat/commit/58a0f26e4d53d5c58d0819ba0a030e035d042539))
* **130842:** decode Furuno 6DOF roll/pitch/yaw rates ([#798](https://github.com/htool/canboat/issues/798)) ([7fda918](https://github.com/htool/canboat/commit/7fda91804e7ccdeb9cd262fd0930a1a626ab8833))
* **130850:** model the AP mode commands as the full 12 bytes ([#795](https://github.com/htool/canboat/issues/795)) ([c9b2fc7](https://github.com/htool/canboat/commit/c9b2fc7d7589d86a9128ddcbc5e1ba8043fd884a))
* **130850:** trim the catch-all AP command to the full 12 bytes ([#796](https://github.com/htool/canboat/issues/796)) ([a1d4b54](https://github.com/htool/canboat/commit/a1d4b54252b3a5f21e5b38fce29c7b64aa7a14cf))
* **540:** expose Unknown/OutOfRange/Reserved special values per field ([#672](https://github.com/htool/canboat/issues/672)) ([20e98c7](https://github.com/htool/canboat/commit/20e98c75673ac6eda0676a0fde0b33cc0ea8968a))
* **540:** per-field-type .sentinels + lookup top-of-range markers ([#704](https://github.com/htool/canboat/issues/704)) ([ce03421](https://github.com/htool/canboat/commit/ce03421e1d257569808a55404cbc7e672cf74716))
* **65301,130819:** decode BEP CZone proprietary PGN fields ([444dd4f](https://github.com/htool/canboat/commit/444dd4f89c5578eca68c125ccf6f8582b31a26c3))
* **65301,130819:** decode BEP Marine CZone PGN fields ([cc39e13](https://github.com/htool/canboat/commit/cc39e139d249ea883ccba4d843abe426583f3414))
* **654:** reconcile PGN database against NMEA 2000 PDF v1.3 ([#671](https://github.com/htool/canboat/issues/671)) ([813bef8](https://github.com/htool/canboat/commit/813bef8d27f54e7edda7628d476568542dc4f672))
* **693:** "NMEA 2000 gateway: network status" PGN — rename + socketcan/actisense emission ([#698](https://github.com/htool/canboat/issues/698)) ([a6f6c78](https://github.com/htool/canboat/commit/a6f6c780730cec3154c7ce77d244d4bd9fcbfa84))
* add 19 Maretron product codes from MConnect ([f1344e3](https://github.com/htool/canboat/commit/f1344e396ff969b469e7ad1cfc8dbd0400eb1ddc))
* add 8 missing PGNs from the NMEA 3.002 field-name list ([#655](https://github.com/htool/canboat/issues/655)) ([#673](https://github.com/htool/canboat/issues/673)) ([3efabb1](https://github.com/htool/canboat/commit/3efabb13075d16c2a1e0f998415f17b4a5a4220f))
* add BEP Marine / CZone proprietary PGN stubs ([2973d72](https://github.com/htool/canboat/commit/2973d72c6ff674bb0c6cdd53ea0f58845554efc9))
* add BEP Marine / CZone proprietary PGN stubs ([32d44ed](https://github.com/htool/canboat/commit/32d44ed731b025e18a8055d26892040a615c5217))
* add BEP Marine fast-packet stubs and Lumishore proprietary PGN ([83c4326](https://github.com/htool/canboat/commit/83c43269cf78fd36c6e848afccad430e540bc60f))
* add BEP Marine fast-packet stubs and Lumishore proprietary PGN ([e3b7dbe](https://github.com/htool/canboat/commit/e3b7dbea11595042977ca7d9d7d9fe0c9ffab066))
* add Carling switchboard PGNs 65300/130921 and fill in Maretron Windlass 130843 ([0a9a72e](https://github.com/htool/canboat/commit/0a9a72e3df30e4281ae19a2246fe08a7ee701162))
* add Carling switchboard PGNs and fill in Maretron Windlass ([a06a1ee](https://github.com/htool/canboat/commit/a06a1eefc3311617ce07e0c7ca59eaa54f110fff))
* add HVAC Status PGN and fill in Maretron infrastructure stubs ([5103b84](https://github.com/htool/canboat/commit/5103b844bf884bb40c531f25a5f2d6e285d17a79))
* add HVAC Status PGN and fill in Maretron infrastructure stubs ([7d77748](https://github.com/htool/canboat/commit/7d77748106c86ad131725be84a4f568f327ef6c0))
* add J1939 Electronic Transmission Controller 1 (PGN 61142) ([5fe672f](https://github.com/htool/canboat/commit/5fe672f3424097e0c774478c950546c58a45f243))
* add J1939 Electronic Transmission Controller 1 (PGN 61142) ([b382493](https://github.com/htool/canboat/commit/b382493e18984d59d1cf421192a0bac309a64765))
* add Maretron Alert Transmission PGN 130819 identity header ([f3663f2](https://github.com/htool/canboat/commit/f3663f25d3450976ba7d64cf985a80c9f695a529))
* add maretron-ipg, a TCP client for the Maretron IPG100 gateway ([3ee1433](https://github.com/htool/canboat/commit/3ee14334568404c7511010b516465f0a6a15664b))
* add maretron-ipg, a TCP client for the Maretron IPG100 gateway ([47f6d1c](https://github.com/htool/canboat/commit/47f6d1c8bb664e1ef6d9b216fe65f2f73542ab0e))
* add Mercury, Yamaha, Navico, B&G and Simrad proprietary PGN stubs ([4fcbbdf](https://github.com/htool/canboat/commit/4fcbbdf6f38b9817a9c1d74db4887ac812d692f0))
* add Navico Naviop and BEP CZone switching PGN stubs ([56acf73](https://github.com/htool/canboat/commit/56acf73202891851a6963a656ce7bacd1a4e8b6a))
* add Navico Naviop and BEP CZone switching PGN stubs ([55ccb18](https://github.com/htool/canboat/commit/55ccb188614eba7eca8e6e6d06c88bb9ac3bffdb))
* add proprietary PGN stubs and resolve PACKET_RESOLUTION_UNKNOWN ([8820443](https://github.com/htool/canboat/commit/8820443a43a2926636c09fed204c3ceb71fd3915))
* add Sea Recovery Watermaker and Webasto Status 2 PGN definitions ([e1d47f0](https://github.com/htool/canboat/commit/e1d47f0e5de8ad2d58da4915d2e46f1c5171ae89))
* add Suzuki, Yanmar and Honda proprietary PGN stubs ([614d1d6](https://github.com/htool/canboat/commit/614d1d686ebde2b09261892d67248dd673ccc8e8))
* add Suzuki, Yanmar and Honda proprietary PGN stubs ([3995b5c](https://github.com/htool/canboat/commit/3995b5c05219e3a7f49e651c86b6b46f8f4c9b0a))
* add Webasto HVAC Command and Carling DC Configuration Command PGNs ([b5a88ed](https://github.com/htool/canboat/commit/b5a88ed2a45f8f693d8d4249efd2de01f4a2280f))
* add Webasto HVAC Command and Carling DC Configuration Command PGNs ([a86fc8c](https://github.com/htool/canboat/commit/a86fc8c950954c9082300038cbfbd9224505ab99))
* add Xantrex and Lumishore proprietary PGN definitions ([3db5e4e](https://github.com/htool/canboat/commit/3db5e4ef9f24eee23a259bffd5d7f07733ee1dc8))
* **analyzer:** normalize emitted timestamps to canonical ISO-8601 UTC ([#750](https://github.com/htool/canboat/issues/750)) ([8f33ead](https://github.com/htool/canboat/commit/8f33eadc17835df070b67cb8951118973bc98e9b)), closes [#749](https://github.com/htool/canboat/issues/749)
* **analyzer:** one full-precision pi, not three approximations ([5c4d296](https://github.com/htool/canboat/commit/5c4d2965d50df76fb7cb0c4b2660edfbca344e20))
* **canboat:** expose the JSON input driver as a library feature ([3130bf1](https://github.com/htool/canboat/commit/3130bf1e44e6dcd5f3032de2f3c795ca4720e29c))
* **canboat:** wasm32 support — target fixes and the JSON input driver as a library feature ([1d7450c](https://github.com/htool/canboat/commit/1d7450c5a3314ac6654998529138bed8f6c3678c))
* **convert:** expose the analyzer's output flags on `canboat convert` ([52869c4](https://github.com/htool/canboat/commit/52869c43c41f42ca67cabfe111bab94ec1cc1292))
* **convert:** re-encode analyzer JSON to wire frames with --from json ([#800](https://github.com/htool/canboat/issues/800)) ([294520b](https://github.com/htool/canboat/commit/294520b5ab1715885b5bd2c9782d6cd524bb5d02))
* **database:** 467 Humminbird is a transposition of 476 ([89413b9](https://github.com/htool/canboat/commit/89413b92a2c7535778f25f89f084463cfce32c2d))
* **database:** add Sleipner S-Link thruster PGNs ([2e86af7](https://github.com/htool/canboat/commit/2e86af7d9771f26cc6e3dcae2474b4a4c1ecd795))
* **database:** add Sleipner S-Link thruster PGNs ([050ed5b](https://github.com/htool/canboat/commit/050ed5b53c4e4488ee39eba46a577a9a1af1106a))
* **database:** add Yanmar, Fusion, and Garmin packet data ([01d0dc3](https://github.com/htool/canboat/commit/01d0dc3dd24328c05cbeee384c477d36ea8066f6))
* **database:** add Yanmar, Fusion, Garmin, and AIS packet data ([135d042](https://github.com/htool/canboat/commit/135d04224ad56ba20472c8907c815c80867b7df1))
* **database:** author minLength for PGNs that appear short on the wire ([d15a487](https://github.com/htool/canboat/commit/d15a487d3a0e16677ec76f5f0fac95835daf9e4b))
* **database:** author minLength, and give three AIS PGNs their trailing Sequence ID ([cb09435](https://github.com/htool/canboat/commit/cb09435cb0cba3b1c858457fcb192c16a16c7178))
* **database:** correct misspelled labels and descriptions ([#858](https://github.com/htool/canboat/issues/858)) ([ada516c](https://github.com/htool/canboat/commit/ada516c5bd0cff53b353304863fdd9c0f4e815ef))
* **database:** correct the NMEA 2000 manufacturer names ([8529baa](https://github.com/htool/canboat/commit/8529baa558187dbf2bb6c1a8e1fce3a2b902c409))
* **database:** correct the NMEA 2000 manufacturer names ([5d7d1c1](https://github.com/htool/canboat/commit/5d7d1c10fc7c3b872f492e8a156b4b95df978f19))
* **database:** give 129039/129793/129794 their trailing Sequence ID ([1d92c86](https://github.com/htool/canboat/commit/1d92c86cf327809fafc68933f64730791e13afc0))
* **database:** give J1939 its own manufacturer-code table ([5db5b34](https://github.com/htool/canboat/commit/5db5b34a7bf2ac54a7a47b666fd94630e01c7440))
* **database:** give J1939 its own manufacturer-code table ([db0d58f](https://github.com/htool/canboat/commit/db0d58fde15eefee23d60632bcee171dc7765266))
* **database:** import the ISO 11783/J1939 manufacturer registry ([bce0c6d](https://github.com/htool/canboat/commit/bce0c6d258ac8d532e91bac9d02f31026ccce815))
* **database:** import the ISO 11783/J1939 manufacturer registry ([88b3f05](https://github.com/htool/canboat/commit/88b3f05f0d9d69ae659e56d3fa3f368659b93b49)), closes [#837](https://github.com/htool/canboat/issues/837)
* **database:** refine Yanmar, Fusion, Garmin, and AIS definitions ([a2908ea](https://github.com/htool/canboat/commit/a2908eae152a4d35aca9ca532170eacf58abec44))
* **dbc:** multiplex proprietary PGN variants; move to docs/canboat.dbc ([#707](https://github.com/htool/canboat/issues/707)) ([859bf85](https://github.com/htool/canboat/commit/859bf859af76c6627b4cd357718dd830f2ac7d38))
* decode Discrete Status 1 bitfield in PGN 127493 ([#419](https://github.com/htool/canboat/issues/419)) ([#667](https://github.com/htool/canboat/issues/667)) ([bd2fb6b](https://github.com/htool/canboat/commit/bd2fb6b92cffba3497cd4c58b1ec77cdecdd7e18))
* decode Garmin autopilot scalar transport over PGN 126720 ([#688](https://github.com/htool/canboat/issues/688)) ([#692](https://github.com/htool/canboat/issues/692)) ([3f6ce56](https://github.com/htool/canboat/commit/3f6ce561f933c3e14769c4c6aa605c341d9f361b))
* **encode:** match the VARIABLE target variant from the parameter pairs ([#811](https://github.com/htool/canboat/issues/811)) ([c301bd5](https://github.com/htool/canboat/commit/c301bd5f19ef607f3d9ebc73ad61676601f5efec))
* fill in Maretron Alert family PGNs 130820/130821/130822 identity headers ([cf3ccf9](https://github.com/htool/canboat/commit/cf3ccf939f662c3ba4ec7b5f3d7713a19c8a0228))
* fill in Maretron Alert family PGNs 130820/130821/130822 identity headers ([f504ad8](https://github.com/htool/canboat/commit/f504ad8db7ee71de1df7803c24203b4bd479cea3))
* fill in Maretron proprietary PGN field layouts + add Carling Breaker Command ([943407f](https://github.com/htool/canboat/commit/943407f254b677ceae8bdd50843f9a446c640dca))
* fold canboat-py extended-decoder notes into Mercury PGN descriptions ([#689](https://github.com/htool/canboat/issues/689)) ([#690](https://github.com/htool/canboat/issues/690)) ([27ca9b5](https://github.com/htool/canboat/commit/27ca9b5f9fe129077949c4a3acd7ff29555e4e39))
* **furuno:** correct PGN 130845 satellite record layout and decode Baseline status ([#723](https://github.com/htool/canboat/issues/723)) ([e72b6d5](https://github.com/htool/canboat/commit/e72b6d5c4790ff1b77f67913d299d76547be1fb7))
* **fusion:** decode additional 130820 status messages ([#682](https://github.com/htool/canboat/issues/682)) ([906dcde](https://github.com/htool/canboat/commit/906dcdebc653f9cc6fac0c50e4069acc1711ca44)), closes [#678](https://github.com/htool/canboat/issues/678)
* **garmin:** decode PGN 126720 Garmin Autopilot Key Value Data ([b034041](https://github.com/htool/canboat/commit/b034041fd6e9bc56a2e33f2c5ae4873a59903266))
* **garmin:** Reactor autopilot mode state, voltage fix, and field lookups ([#753](https://github.com/htool/canboat/issues/753)) ([a349344](https://github.com/htool/canboat/commit/a349344fdb10402686bc43d01b99eecd396be96b))
* **interface:** network line gateways - Yacht Devices RAW and W2K-1 N2K ASCII ([#807](https://github.com/htool/canboat/issues/807)) ([7664d29](https://github.com/htool/canboat/commit/7664d29801af2f6fda5c10a9bae830af47cae4ed))
* **j1939:** add 22 engine, aftertreatment and fluid PGNs ([e1f9556](https://github.com/htool/canboat/commit/e1f95567ba2ecd6d502236a4d09642e4a233336c))
* **j1939:** add 25 engine, transmission, aftertreatment and fluid PGNs ([0724548](https://github.com/htool/canboat/commit/07245480e31a7ce70e67c9821db3fa2c5652e2d9))
* **j1939:** add transmission, rated power and gear PGNs ([bf6cfe7](https://github.com/htool/canboat/commit/bf6cfe7adebfd86286fcbc80b7524d5e2b10f3d0))
* **j1939:** bring the J1939 schema flavor to the Rust tools, with candump input ([bdd469d](https://github.com/htool/canboat/commit/bdd469d8f7cece4ea5c88d311abe432b4ed74b65))
* **j1939:** complete the standard engine PGN definitions ([13ebfc5](https://github.com/htool/canboat/commit/13ebfc5ba61dd744b54fa9c1faba1bc79353edba))
* **j1939:** complete the standard engine PGN definitions ([253bebd](https://github.com/htool/canboat/commit/253bebd7d38152532487caa9f1adf651dca8df4e))
* **j1939:** J1939 schema flavor for the Rust tools, with candump input ([8c2ab99](https://github.com/htool/canboat/commit/8c2ab99b2510d0e142dcf9b6f19b1ac273369bbb))
* **json:** default decoded output to camelCase ids and SI units ([#814](https://github.com/htool/canboat/issues/814)) ([9a0ad2c](https://github.com/htool/canboat/commit/9a0ad2c2a531c7be8505376a9de648a1daee01aa))
* **keel:** + New Lookup wizard ([ecdb5cb](https://github.com/htool/canboat/commit/ecdb5cb8931d16d815674609b9c64f11c0914e64))
* **keel:** add 'keel harvest' subcommand + YDWG RAW parsing ([2270304](https://github.com/htool/canboat/commit/22703040a0de61634da34911bde14a629fa4764d))
* **keel:** add 'keel rules' subcommand; rule inventory lives in source ([c591a28](https://github.com/htool/canboat/commit/c591a28675b92912c7dc98ec9708be6f7d307c2f))
* **keel:** allowLookupWidthMismatch opt-in; resolve F2, answer F3 ([1e0ca5b](https://github.com/htool/canboat/commit/1e0ca5b319a134f24b9daca983b8636bad211384))
* **keel:** author repeating field sets in the editor ([f2fcdde](https://github.com/htool/canboat/commit/f2fcddeb1de3f33c898edad293c86c9cfa58b406))
* **keel:** author the BINARY bit-length reference instead of guessing it ([fb1d280](https://github.com/htool/canboat/commit/fb1d2801b4dd3bcf92d487b169736684d706b24f))
* **keel:** convert Actisense/iKonvert BEM pseudo-PGNs; add QUIRKS.md catalog ([3cac460](https://github.com/htool/canboat/commit/3cac46033349a38e6954fa225ec4373f0f2486ca))
* **keel:** decoder core, sample parsing/reassembly, keel decode, R40 sample tests ([d2b24ea](https://github.com/htool/canboat/commit/d2b24ea7710041438a3a5204fbafc0402cebc363))
* **keel:** DYNAMIC_FIELD_VALUE takes its type+length from the key ([44756e1](https://github.com/htool/canboat/commit/44756e13d20d63e380a0fe811872bab62846999d))
* **keel:** editor - explicit Validate button + resizable sidebar ([04906fa](https://github.com/htool/canboat/commit/04906fa2ddb9f6fbd3aa8fea8db3b59b95e4cdef))
* **keel:** editor - rich fieldtype picker, type-mandated attributes, auto preamble ([040eb8b](https://github.com/htool/canboat/commit/040eb8b8ecd5814928324448dedfce021833ac68))
* **keel:** editor — grid usability, note help, reserved/spare lockdown ([c8ba783](https://github.com/htool/canboat/commit/c8ba7837a5fe3488e49261cf09dcda1c45d51864))
* **keel:** editor — match value-name suggestions; emit ranges as floats ([8317042](https://github.com/htool/canboat/commit/8317042f5b9a55ac358340f11833983465e1ab3f))
* **keel:** editor — one-field modal with per-attribute help + lossless save ([1ca0bd9](https://github.com/htool/canboat/commit/1ca0bd9d7cbf193bcb20406938c7b2d84c63c558))
* **keel:** editor round 2 - evidence for existing PGNs, lookup view/edit ([5a786d2](https://github.com/htool/canboat/commit/5a786d2898189e1c8ccf97df54eec3dbea5764b4))
* **keel:** editor scratch mode + undo-this-edit ([6fd2cb7](https://github.com/htool/canboat/commit/6fd2cb774f69910ff0968beac24b526a477b1439))
* **keel:** emit Resolution at full precision, restore the exact values ([e6ee07d](https://github.com/htool/canboat/commit/e6ee07d9ad943ae27d911d925f3559d3d7f9092a))
* **keel:** emit Resolution at full precision, restore the exact values ([8121860](https://github.com/htool/canboat/commit/81218605b43e99b58bcbe328b6e061a74460c2c2))
* **keel:** emit the Rust tables so the crates can be published ([04b6756](https://github.com/htool/canboat/commit/04b67561b89b68ef7d78126a816ad3cdd6a91082))
* **keel:** emit the Rust tables so the crates can be published ([8ad0d78](https://github.com/htool/canboat/commit/8ad0d78e8877ec7c0b481d25f32073b879dbca80))
* **keel:** entered data never matches a fallback PGN ([c67bc49](https://github.com/htool/canboat/commit/c67bc4933223d900137f197d13269d61250d520c))
* **keel:** evidence grid - coalesced field spans, exact bit spans from decode ([d28ea4c](https://github.com/htool/canboat/commit/d28ea4c34b7e54bd0bbdac7cc7d81efeb86cbf99))
* **keel:** J1939 database tree; fix pgn-j1939.h data bugs found on the way ([3c3d29e](https://github.com/htool/canboat/commit/3c3d29e86d3a4d0ce7ccecff088d3aa803464bb0))
* **keel:** live decode shows DATE/TIME/DURATION in human form ([fae3eaf](https://github.com/htool/canboat/commit/fae3eafe1fe71a5848c655ff30905dee1ad26a14))
* **keel:** lookup editor handles triplet and fieldtype kinds ([d9c127b](https://github.com/htool/canboat/commit/d9c127b583bebae57c7d1554c18d01b5bc097a44))
* **keel:** PGN database migration step 1 - YAML source tree + byte-identical XML round trip ([18b998f](https://github.com/htool/canboat/commit/18b998f24b68bd223d67ffb9ff8acab2328d61fe))
* **keel:** post-save dialog with next-step actions + /api/generate ([8c5b663](https://github.com/htool/canboat/commit/8c5b6631dbc45053e7a9bc7401ef44259357f059))
* **keel:** R14 — a field may not re-specify type-fixed bits/resolution ([2116b6d](https://github.com/htool/canboat/commit/2116b6d72f99eb8853a7ed321ee1f255957f4b17))
* **keel:** R15 — assert a variable-length BINARY field's bit-count field ([d55150c](https://github.com/htool/canboat/commit/d55150c16a867a24bf03ebf089f041bb442a1ba6))
* **keel:** re-harden R20 to error now that duplicates are pruned ([316fae1](https://github.com/htool/canboat/commit/316fae1f7fbd5663e6bdd913560b1174c9cc37c2))
* **keel:** step 2 - rule engine (keel check) ([f714bf0](https://github.com/htool/canboat/commit/f714bf0737a67baa760bed9315a3595ddd4301f6))
* **keel:** step 3 - generate the C tables from database/ ([60509d8](https://github.com/htool/canboat/commit/60509d8a399769d55d91b5b9c4ee01440314224e))
* **keel:** step 4 - port pgn.h/lookup.h research comments to YAML notes ([681891d](https://github.com/htool/canboat/commit/681891d11776128d19f2c414a543ea3d55f49c7c))
* **keel:** suggest near-miss variants to clone from ([c5efc73](https://github.com/htool/canboat/commit/c5efc739e5f430a2c509eebab7b58c784df67ed2))
* **keel:** surface unnamed lookup values as evidence, wire to enum editor ([4116a15](https://github.com/htool/canboat/commit/4116a150b558dca3b0a2f0325b071f7b533a44cd))
* **keel:** the editor - keel edit wizard with evidence grid and live decode ([03ffff5](https://github.com/htool/canboat/commit/03ffff5e1a50d62b147d015a378988724cddba23))
* **keel:** validate match values (R13); accept lookup names in match ([320977e](https://github.com/htool/canboat/commit/320977ea9a73feff3bf706068613dd535956d8b3))
* **mercury:** decode VesselView-Link PGNs 130824/130825/130826/130829 ([#683](https://github.com/htool/canboat/issues/683)) ([9f380a8](https://github.com/htool/canboat/commit/9f380a8ac5694702fc4d818264a0fabae1fe785e))
* **navico:** add 130824 B&G start-line & MOB position keys ([#708](https://github.com/htool/canboat/issues/708)) ([2938fd8](https://github.com/htool/canboat/commit/2938fd80be71d3c2117c35f823007ed069c67d08))
* **navico:** add compass auto-calibration mode key; fix Local field units (130845) ([#720](https://github.com/htool/canboat/issues/720)) ([e59571c](https://github.com/htool/canboat/commit/e59571c5a47d3ce3eead7f2c7473913f9782a675)), closes [#718](https://github.com/htool/canboat/issues/718)
* **navico:** correct PGN 65350 layout to normalized magnetic field vector X/Y/Z ([#719](https://github.com/htool/canboat/issues/719)) ([4426234](https://github.com/htool/canboat/commit/44262343b2bec327b8ad26c3eacbdaa70e149486)), closes [#716](https://github.com/htool/canboat/issues/716)
* **navico:** decode 65313 Depth Quality and 130825 NDP2k Alert ([#686](https://github.com/htool/canboat/issues/686)) ([8df21c8](https://github.com/htool/canboat/commit/8df21c8466d9112f24828a119ec1b7717bd80358))
* **navico:** decode five proprietary Navico/Simrad/Lowrance PGNs ([#743](https://github.com/htool/canboat/issues/743)) ([6f47c34](https://github.com/htool/canboat/commit/6f47c343b67db04c53b34b1126a3a1d04eca0768))
* **navico:** decode PGN 130822 Command 3 "Bulk Report 3" Section 10 settings ([#733](https://github.com/htool/canboat/issues/733)) ([ac21513](https://github.com/htool/canboat/commit/ac21513352688a90d253a3f185347b2ca086ef24))
* **navico:** decode PGN 130823 directory records, 130817 feature-unlock, and harden group-function/key-value handling ([#741](https://github.com/htool/canboat/issues/741)) ([c41bdd5](https://github.com/htool/canboat/commit/c41bdd5c90c454072b695014a5c9ace90ded226e))
* **navico:** decode PGN 130845 display unit-preference keys ([#729](https://github.com/htool/canboat/issues/729)) ([dab64cd](https://github.com/htool/canboat/commit/dab64cd0b409aa3e4c2e11ce92a3e91b00e043f1))
* **navico:** decode PGN 130845 instrument damping settings ([#730](https://github.com/htool/canboat/issues/730)) ([#731](https://github.com/htool/canboat/issues/731)) ([244abdf](https://github.com/htool/canboat/commit/244abdfdcbe9aa7b8c432448f6dfd47742c4d552))
* **navico:** decode proprietary PGNs 65303/65304, 130823, 130852 ([#728](https://github.com/htool/canboat/issues/728)) ([5003dff](https://github.com/htool/canboat/commit/5003dff6c0d2358c14d0ae8d7c9f24a6bbfe90df))
* **navico:** decode SIMNET_ALARM_COMMAND 88 as Tack/Gybe Confirm ([#739](https://github.com/htool/canboat/issues/739)) ([98b5240](https://github.com/htool/canboat/commit/98b52409c879779c47c2826424dec13310591397))
* **navico:** drop PGN 130861 "Simrad: Engine Data" — no producer exists ([#721](https://github.com/htool/canboat/issues/721)) ([28d39e7](https://github.com/htool/canboat/commit/28d39e740e46c7aab40738e1cff85664e7046c55)), closes [#712](https://github.com/htool/canboat/issues/712)
* **navico:** resolve PGN 65323 & 130840 Simnet Data Source Selection ([#725](https://github.com/htool/canboat/issues/725)) ([20fee4f](https://github.com/htool/canboat/commit/20fee4f49fc16305e1450a10808a865e11a062dc))
* **navico:** rework Simnet 130845/130846 Key/Parameter PGNs from firmware ([#701](https://github.com/htool/canboat/issues/701)) ([9fe36ac](https://github.com/htool/canboat/commit/9fe36ac99ad6f562c286798daac4f661757647a8))
* **navico:** unify SIMNET_DISPLAY_GROUP into SIMNET_NETWORK_GROUP ([#732](https://github.com/htool/canboat/issues/732)) ([1e6a7e6](https://github.com/htool/canboat/commit/1e6a7e679e12b29f04861ee609f2e319f91f0dcd))
* **pk:** mark Function Code (126464) and Report (65305) as PartOfPrimaryKey ([#713](https://github.com/htool/canboat/issues/713)) ([e0348ad](https://github.com/htool/canboat/commit/e0348ade718c030c3312e6bd8542f221e76222a3))
* **quirk:** correct dates from a GPS that missed the week rollover ([#863](https://github.com/htool/canboat/issues/863)) ([8fcfd48](https://github.com/htool/canboat/commit/8fcfd4818e95775e607d1157fda0c3a01ff9d404))
* read Actisense W2K-1 files in actisense-serial ([#662](https://github.com/htool/canboat/issues/662)) ([c460636](https://github.com/htool/canboat/commit/c460636c218cc98c4c72f12c36bedc30865f6142))
* read PCAN-View trace files in candump2analyzer ([#250](https://github.com/htool/canboat/issues/250)) ([#665](https://github.com/htool/canboat/issues/665)) ([1123b97](https://github.com/htool/canboat/commit/1123b975f5e97f8932e9ed673f56e9183b1f9b78))
* reassemble ISO 11783-3 Transport Protocol (PGN 60416/60160) messages ([#736](https://github.com/htool/canboat/issues/736)) ([339669b](https://github.com/htool/canboat/commit/339669b8e6862a859a5747a947d067215cdc372c))
* **release:** publish the Rust canboat binary for Windows ([#808](https://github.com/htool/canboat/issues/808)) ([b4e84cf](https://github.com/htool/canboat/commit/b4e84cf6f1d92d948e2a38aa96d8dcb82a482cf5))
* **release:** publish the Rust canboat binary with every release ([#799](https://github.com/htool/canboat/issues/799)) ([e33247c](https://github.com/htool/canboat/commit/e33247ccd01b1110f59c9c773297510fa8ef2a0e))
* **rust:** derive the compiled-in schema from database/*.yaml via keel ([a358ff7](https://github.com/htool/canboat/commit/a358ff728110bfc5b21703c82d2bd55851664438))
* **rust:** merge canboat-rs into rust/, reading the live schema ([aa122f8](https://github.com/htool/canboat/commit/aa122f867650ecd46b3e2d68e534b723d97043fc))
* **seatalk:** add alarm IDs 112/113/122-125 and Bluetooth alarm group ([#709](https://github.com/htool/canboat/issues/709)) ([893287b](https://github.com/htool/canboat/commit/893287b2e93c14e6e318073a4878db5d436d9dc1)), closes [#552](https://github.com/htool/canboat/issues/552)
* **sleipner:** correct S-Link thrust command split, add PPC thruster telemetry ([011b296](https://github.com/htool/canboat/commit/011b29662d618e4e4d25ea2c8291223fb55022da))
* **sleipner:** correct S-Link thrust command split, add PPC thruster telemetry ([4b1ad62](https://github.com/htool/canboat/commit/4b1ad62b496a9b66fa4accf3bed18148e0d57e70))
* **socketcan:** manage the CAN link lifecycle via netlink ([114dd1a](https://github.com/htool/canboat/commit/114dd1acaa37a645cca1f462d2bc778ceb50d36f))
* switchover - keel owns all generation (migration step 5) ([f4672e2](https://github.com/htool/canboat/commit/f4672e2b2c127e5787e2060852ead92727501206))
* **victron:** decode VE.Can VREG registers via a key/value/type table (61184) ([#681](https://github.com/htool/canboat/issues/681)) ([99c4c0a](https://github.com/htool/canboat/commit/99c4c0ab6fae970b79fe3884019050b526a2666d)), closes [#677](https://github.com/htool/canboat/issues/677)


### Fixed

* **126993:** heartbeat "Data transmit offset" is in milliseconds ([#696](https://github.com/htool/canboat/issues/696)) ([d6afb2a](https://github.com/htool/canboat/commit/d6afb2ab457a1e23d1a16f64a2001ac08939b3fa))
* **130819:** correct annunciator control path and capture provenance ([1e1929b](https://github.com/htool/canboat/commit/1e1929b2083852cb865476e43b18e47bf6678e4f))
* **130820:** BEP CZone alarm string response ([62aed9a](https://github.com/htool/canboat/commit/62aed9a126db735528eac20f8a44f461bbdb7587))
* **130820:** BEP CZone alarm string response (builds on [#636](https://github.com/htool/canboat/issues/636)) ([82d2ecd](https://github.com/htool/canboat/commit/82d2ecd27f72237f0c5b6edcfaaa17a6c8faf59f))
* **130830:** correct field sizes for Maretron Dometic HVAC Status ([8b92002](https://github.com/htool/canboat/commit/8b9200234cfdd51a0c024acdc9358ee4cc330d27))
* **130830:** correct field sizes for Maretron Dometic HVAC Status ([0099608](https://github.com/htool/canboat/commit/009960866c2c14be494be92bbb79ad66abefbc2b))
* **65020:** apparent power is in VA, not VAR ([#853](https://github.com/htool/canboat/issues/853)) ([a4901df](https://github.com/htool/canboat/commit/a4901df6135444814f4294faec1b14f0231b139e))
* add field resolutions and names for Maretron proprietary PGNs ([049c761](https://github.com/htool/canboat/commit/049c76150df1e37d861952493b841d79d3666590))
* allow already reassembled messages to exceed the fast packet length ([#754](https://github.com/htool/canboat/issues/754)) ([35910de](https://github.com/htool/canboat/commit/35910de74eb12f4961579ff6f93f92b8630d38a6))
* **analyzer:** decode 126208 parameters against a proprietary PGN ([d141155](https://github.com/htool/canboat/commit/d141155d74897d2b0b19204a8f0c4618fa227872))
* **analyzer:** decode 8-bit string fields as UTF-8 with a Latin-1 fallback ([#866](https://github.com/htool/canboat/issues/866)) ([15807ce](https://github.com/htool/canboat/commit/15807ce529627db407e0d9ba68bd34d022579afa))
* **analyzer:** key JSON/text output on -camel mode, not camelName presence ([#746](https://github.com/htool/canboat/issues/746)) ([f890862](https://github.com/htool/canboat/commit/f8908620578172d9afb73cfc3f2cab8875e05b8b)), closes [#745](https://github.com/htool/canboat/issues/745)
* **analyzer:** key naming decisions on showCamel mode, not camelName presence ([895b0b6](https://github.com/htool/canboat/commit/895b0b64cce7ee57c0abdb0a16c988a14f1bc5f8))
* avoid signed left-shift overflow in fast-packet reassembly ([#650](https://github.com/htool/canboat/issues/650)) ([ef5b1c5](https://github.com/htool/canboat/commit/ef5b1c50685abe550a12df561dba8a55ab1c97cb))
* change SID fields from BINARY to UINT8 ([439c9e6](https://github.com/htool/canboat/commit/439c9e6fcb52d03cac9a69399ae2d1d91901ad3a))
* **ci:** drop --offline from the release Cargo.lock re-stamp ([a77a4e5](https://github.com/htool/canboat/commit/a77a4e54e7e2ddb9e8dab46f7246659a1b4baaa6))
* **ci:** re-stamp rust/Cargo.lock on the release PR ([49dbf3a](https://github.com/htool/canboat/commit/49dbf3abb9ede57d9db038e9beda0680d7983f7a))
* **convert:** keep the human PGN description in camelCase mode ([#810](https://github.com/htool/canboat/issues/810)) ([b039e00](https://github.com/htool/canboat/commit/b039e008eb00c55612405e7f24d2532f7d7d609c))
* **core:** build and run on wasm32 targets ([c981917](https://github.com/htool/canboat/commit/c981917fd2aa713478896611dda39d0cf2d1b5e7))
* correct Maretron Windlass PGN assignments and add Carling PGNs ([83e47c0](https://github.com/htool/canboat/commit/83e47c0d53413ec184e5900a945ec16107dafc74))
* correct SIMNET Alert bits field length to 64 bits ([#657](https://github.com/htool/canboat/issues/657)) ([c104d8e](https://github.com/htool/canboat/commit/c104d8e7bb2d53d7bae3dc56f92aa91dfee0fb0a))
* decode parity between canboat convert and the C analyzer ([20c0b26](https://github.com/htool/canboat/commit/20c0b266ab8bbff8a89b4e2c4d0bd91db70752a2))
* decode STRING_LAU fields with 0xff encoding byte as empty ([#740](https://github.com/htool/canboat/issues/740)) ([97881b5](https://github.com/htool/canboat/commit/97881b53620d22913a66318aee854a1d4f41d892))
* **decode:** apply the range-derived sentinels to hints-less number fields ([5696fca](https://github.com/htool/canboat/commit/5696fca1e69d664cb4bae3480ad8431d8fa753e5)), closes [#823](https://github.com/htool/canboat/issues/823)
* define PGN 127751 as fast packet, flag as unconfirmed ([#655](https://github.com/htool/canboat/issues/655)) ([#669](https://github.com/htool/canboat/issues/669)) ([a178ddf](https://github.com/htool/canboat/commit/a178ddf8a95ffe2992dcc9616f1323f8d84780e2))
* **docs:** correct arming command count and command fixture labelling ([2855aba](https://github.com/htool/canboat/commit/2855aba466ebca4897ae21ec47c8060efabedaea))
* don't fail a PGN when only a trailing reserved/spare field is short ([#663](https://github.com/htool/canboat/issues/663)) ([#664](https://github.com/htool/canboat/issues/664)) ([5788c7f](https://github.com/htool/canboat/commit/5788c7f571ebf383e61f9c369357a94fda410442))
* don't let fast-packet frame 0 complete against stale frames ([#738](https://github.com/htool/canboat/issues/738)) ([65d5599](https://github.com/htool/canboat/commit/65d55997e2b4eeb006ded2475456503afbf9baee))
* drop CAN 1.0 (11-bit) standard frames ([#647](https://github.com/htool/canboat/issues/647)) ([c9f5285](https://github.com/htool/canboat/commit/c9f5285f0618ff3722fbd5c26471449c946beff7)), closes [#400](https://github.com/htool/canboat/issues/400)
* drop the CANboat startup record from analyzer output under -fixtime ([#668](https://github.com/htool/canboat/issues/668)) ([27c3ef7](https://github.com/htool/canboat/commit/27c3ef706062b7c8d6f860a9c1c202c61da8b61b))
* **encode:** absent repeating-list count encodes as zero ([#816](https://github.com/htool/canboat/issues/816)) ([d7f47d8](https://github.com/htool/canboat/commit/d7f47d82f527b3af3c31817862deb97bdf6ebae0))
* escape control characters in JSON, and emit gateway status from the NGT-1 ([5ffa436](https://github.com/htool/canboat/commit/5ffa43655a1cdb98773ba7f98f0d5ffb1c0c2573))
* escape control characters in JSON, and emit gateway status from the NGT-1 ([16103b6](https://github.com/htool/canboat/commit/16103b69665c354174bcf04e805b24dea3e98c7b))
* **fieldtypes:** drop the phantom terminating zero from STRING_LAU ([e336627](https://github.com/htool/canboat/commit/e336627a601cc81e34298b261aab3c7efede59f9))
* **fieldtypes:** drop the phantom terminating zero from STRING_LAU ([6fa05aa](https://github.com/htool/canboat/commit/6fa05aa862522001a958cc43b8a9a1a3918519eb)), closes [#760](https://github.com/htool/canboat/issues/760)
* fold the release re-stamp into release-please's own commit ([67a580c](https://github.com/htool/canboat/commit/67a580ccd4fde032988ed4410ee1d4688b8c3962))
* **garmin:** drop 126720 key-value editor test data from this branch ([e99034f](https://github.com/htool/canboat/commit/e99034f1db34b6ccf5d5c2dd10f6286e718e68aa))
* give BEP Marine proprietary PGN stubs unique names ([2516b4d](https://github.com/htool/canboat/commit/2516b4d1bf2209df33c29cc2e6384833920412c6))
* give BEP Marine proprietary PGN stubs unique names ([b7b8ebf](https://github.com/htool/canboat/commit/b7b8ebf2f097c055ae521b82ca66022cc0970dc7))
* guard int64 conversion of field range maximum ([#651](https://github.com/htool/canboat/issues/651)) ([0c18ddc](https://github.com/htool/canboat/commit/0c18ddcdcd670c2fcf8f4ee6ca1f3bf31b784d18))
* honor explicit rangeMax in extractNumberNotEmpty ([d7774ba](https://github.com/htool/canboat/commit/d7774bac04276052edf5e6a5b2934f6f90fc9330))
* honor explicit rangeMax in extractNumberNotEmpty ([c7310ec](https://github.com/htool/canboat/commit/c7310ecea2e374dacda5256fad1a265853da915e)), closes [#600](https://github.com/htool/canboat/issues/600)
* **interface:** accept the C maretron-ipg device syntax in the shim ([#801](https://github.com/htool/canboat/issues/801)) ([9737785](https://github.com/htool/canboat/commit/973778585b9ba96d49d9cd739df254ff3d8d200f))
* **json:** always emit string-typed elements as JSON strings ([#793](https://github.com/htool/canboat/issues/793)) ([d6a1cab](https://github.com/htool/canboat/commit/d6a1cab1a3133cb55c6be8091889dd7a4939d629))
* **json:** export Signed for keyed (DYNAMIC_FIELD_VALUE) field types ([#691](https://github.com/htool/canboat/issues/691)) ([f705ea4](https://github.com/htool/canboat/commit/f705ea4d6c0d701ae61c7ab306cc2e8e57396451))
* **keel/bootstrap:** add 'keel convert --xml' so resync prunes orphans ([f1b0dcb](https://github.com/htool/canboat/commit/f1b0dcb2d7ec7c4e61cea0e2b5c9d0c0c14e7c79))
* **keel:** build on Windows; make Windows release resilient ([d74e5fb](https://github.com/htool/canboat/commit/d74e5fb379e8f7e5793da48a458033449dbec3f4))
* **keel:** decode FLOAT and DECIMAL fieldtypes; show units + friendly conversions ([cbc84f8](https://github.com/htool/canboat/commit/cbc84f82f0641d3e5dbf0b0306a61c0e8568dc2c))
* **keel:** decoded numbers print with resolution-derived precision ([730c411](https://github.com/htool/canboat/commit/730c41153b6cfadefa269992c5464dc4e1549c5c))
* **keel:** don't let the Resolution round-trip shorten what %g prints exactly ([dac737e](https://github.com/htool/canboat/commit/dac737e63e0499ae9d6abf789e2a8163b635ba86))
* **keel:** editor paste-first flow - known PGNs open with pastes as evidence ([3ebf9ec](https://github.com/htool/canboat/commit/3ebf9ece08aaa98df261d7b00b6a21429b9e7d6f))
* **keel:** emit every lookup, not only those pinned in the order file ([3d0b642](https://github.com/htool/canboat/commit/3d0b642881aae6e0b1ff2e9db1b699fedf4ae1a9))
* **keel:** enforce R01's allowed keys and enum membership in the loader ([85a5249](https://github.com/htool/canboat/commit/85a52495ad3a1be10eb447b52c25afbc3bbc9a51))
* **keel:** enforce R01's allowed keys and enum membership in the loader ([8aac808](https://github.com/htool/canboat/commit/8aac80880934348658d4f6fe0c87397cefb23984))
* **keel:** field lookup references use the enum's kind; clearer R08 ([fc94a02](https://github.com/htool/canboat/commit/fc94a0258068837004faba885bf04aa577370636))
* **keel:** link legacy_stdio_definitions on MSVC for snprintf ([e3af259](https://github.com/htool/canboat/commit/e3af2596742585e02a09b7e2ea9b7a1278c69336))
* **keel:** lookup edit button was hidden; browse/edit enums from sidebar ([7b37784](https://github.com/htool/canboat/commit/7b37784a9cfd45340d6e46d53e2854a193887523))
* **keel:** metadata fields drive the YAML + save path; guard wrong-file save ([7c932ac](https://github.com/htool/canboat/commit/7c932ace0e2317c8f4188dbccc74b39cd20dc552))
* **keel:** newly-created lookup is usable in the same session ([fb0b242](https://github.com/htool/canboat/commit/fb0b242ff535656e3e51b3562ffea66a4e018cf4))
* **keel:** R40 tolerates display-precision float expectations ([55458d7](https://github.com/htool/canboat/commit/55458d7d8bed4267ecf5c873159e530d29c58bae))
* **keel:** shim falls back to v8.0.0 releases when 'latest' has no keel ([dff234f](https://github.com/htool/canboat/commit/dff234f65b98db80a45743cbd2236f6f2bd079d9))
* **keel:** use M_PI for the rad range clamp, not 3.1415926 ([8b8f58a](https://github.com/htool/canboat/commit/8b8f58a3e35299da51dfb62391588057a2376a1d))
* **lookup:** reconcile lookup bit-lengths with field widths ([#751](https://github.com/htool/canboat/issues/751)) ([1bbcb9f](https://github.com/htool/canboat/commit/1bbcb9f9a8d44c73810d0861be91f6ee47aa6f14))
* **navico:** correct 130822 Configuration Set naming and periodicity ([#734](https://github.com/htool/canboat/issues/734)) ([5a328c4](https://github.com/htool/canboat/commit/5a328c46a3f0146a3c75a75160791e5d73167cdd))
* **navico:** rename PGN 130846 to "Simnet: Key Value - Long" ([#705](https://github.com/htool/canboat/issues/705)) ([a2c9a43](https://github.com/htool/canboat/commit/a2c9a4370cc7b356f8d7a58642c177851cdee209))
* never write to a replayed file in actisense-serial ([#660](https://github.com/htool/canboat/issues/660)) ([#661](https://github.com/htool/canboat/issues/661)) ([2db94ad](https://github.com/htool/canboat/commit/2db94ade17f5b735209404bbd5d55c0e63218ef4))
* prevent out-of-bounds read for out-of-range PGNs ([#649](https://github.com/htool/canboat/issues/649)) ([a5a22b7](https://github.com/htool/canboat/commit/a5a22b74b9ac5688019cba62669df08562cebd6f)), closes [#644](https://github.com/htool/canboat/issues/644)
* print a sub-second duration as a decimal, not as raw units ([eae95a8](https://github.com/htool/canboat/commit/eae95a8bd3b2eb8225d25f5d937ad3b662871043))
* resolve PACKET_RESOLUTION_UNKNOWN for multiple PGNs ([b77763e](https://github.com/htool/canboat/commit/b77763e5d5c56a84e37e0f2cb57cd94b475e6208))
* revert 130824 Annunciator field rename to match canboatjs tests ([bf5348c](https://github.com/htool/canboat/commit/bf5348cac693b1e382e50420c9caac14fccb7c7e))
* revert Maretron Annunciator 130824 to generic field names ([6471f78](https://github.com/htool/canboat/commit/6471f78545bdde02b63990a8eac0a0970e58843d))
* **rust:** cap STRING_FIX to the message instead of dropping it ([94a8b3d](https://github.com/htool/canboat/commit/94a8b3d7884e9658dce997ba09d0307b7aec066e))
* **rust:** decode DECIMAL as decimal pairs, not as an integer ([7c78a70](https://github.com/htool/canboat/commit/7c78a70aa0f762d3f10c037ef6748e908807d53e))
* **rust:** detect the unavailable sentinel on 64-bit fields ([f71a5df](https://github.com/htool/canboat/commit/f71a5dffda52fe4f0a3b35d93859fce7c7961f66))
* **rust:** don't let install-shims overwrite an installed program ([0d92668](https://github.com/htool/canboat/commit/0d92668cffaa32cc0acfced8c06fb0d5589ba9c7))
* **rust:** don't let install-shims overwrite an installed program ([17e6c09](https://github.com/htool/canboat/commit/17e6c09cd593af50a350bc3f23c54b3f1c91b09d))
* **rust:** don't strip sentinels from DYNAMIC_FIELD_VALUE fields ([4c05112](https://github.com/htool/canboat/commit/4c051122282430d40309e3e75b947d79f952bfdb))
* **rust:** drop Out Of Range and Reserved sentinels from JSON ([a6bfcc8](https://github.com/htool/canboat/commit/a6bfcc8131b5574865f353e0a711d9dee7c3494e))
* **rust:** honour DynamicFieldLengthOverhead when sizing dynamic values ([593d817](https://github.com/htool/canboat/commit/593d817f028c502b6a2f24f10c1834f4e2ed8c06))
* **rust:** keep RESERVED and SPARE bytes at their bit position ([1399f34](https://github.com/htool/canboat/commit/1399f345b98f5f9fe157d47a1c60f1256efb5d69))
* **rust:** keep set bits a BITLOOKUP enumeration does not name ([f8d7f61](https://github.com/htool/canboat/commit/f8d7f6154411cac45adc95f4c165f271e14207e7))
* **rust:** let a near-tie round the way printf does ([3e3b1b4](https://github.com/htool/canboat/commit/3e3b1b44b23dceb1947737a139c7034d775cdbf6))
* **rust:** let the decoder own the all-ones Reserved decision ([69d006d](https://github.com/htool/canboat/commit/69d006dc255088f178fd11cbc3bc908f14705cbe))
* **rust:** match canboat on sub-byte BINARY and unnamed lookup values ([a31cf5e](https://github.com/htool/canboat/commit/a31cf5e3ab19672c5ee0bf427c04387247460a3f))
* **rust:** print FLOAT fields with C's %g, not shortest-round-trip ([b1c2c71](https://github.com/htool/canboat/commit/b1c2c714dcfca60a48939e8d4afad9095645b3a3))
* **rust:** reject a plain/fast line that carries no payload section ([204aee0](https://github.com/htool/canboat/commit/204aee09d2b15d78732b5cfe3a4ec807fee43580))
* **rust:** render a non-zero SPARE inside an ISO NAME ([2fd38e5](https://github.com/htool/canboat/commit/2fd38e56d9e17b9c7bc24bc848c7ead478ea2b0f))
* **rust:** require the direction token when detecting YDWG-02 ([bd53da4](https://github.com/htool/canboat/commit/bd53da4a55936a0b0c85c3712ab98a86f5f641c9))
* **rust:** resolve 126208 parameter targets the way the C does ([f2cec7c](https://github.com/htool/canboat/commit/f2cec7c6e45c14896b07a095756a87e244963bd4))
* **rust:** round ties to even when formatting fixed-precision floats ([0775cae](https://github.com/htool/canboat/commit/0775caecd0d8120a4655c934767fd493d8f30bc4))
* **rust:** route a dynamic LOOKUP through the same unnamed-value rule ([4c08aa6](https://github.com/htool/canboat/commit/4c08aa6f4191a57c830e37828f3b4f0b50313fd4))
* **rust:** satisfy clippy 1.98's chunks_exact_to_as_chunks ([b165859](https://github.com/htool/canboat/commit/b165859dd8cb3fabd4ba5de9acac30dda905d3ac))
* **rust:** satisfy clippy 1.98's chunks_exact_to_as_chunks ([866c509](https://github.com/htool/canboat/commit/866c509cc23b121445773413a65c1f7b490c8ad3))
* **rust:** size a zero-width BINARY from the preceding field ([82db1fa](https://github.com/htool/canboat/commit/82db1fa86a8d303fb663e6bc104063ea1b45f36e))
* **rust:** suppress an MMSI above its RangeMax ([5be1fe7](https://github.com/htool/canboat/commit/5be1fe7c886b2caafd7d961601fcb53f5f752fd1))
* **rust:** suppress the top two ISO NAME values ([f98bfb7](https://github.com/htool/canboat/commit/f98bfb77185c4f038d4de368f5e067dd45daa7bb))
* **rust:** take a dynamic value's signedness from its field type ([e8e9757](https://github.com/htool/canboat/commit/e8e97579521dec8e012007b7f9936b901646b640))
* **rust:** take the rest of the frame when a dynamic key won't resolve ([55a21fd](https://github.com/htool/canboat/commit/55a21fd8dca28fb0298b7e6dcf812de47b74134b))
* **rust:** trim the whole isspace() set off decoded strings ([11a238f](https://github.com/htool/canboat/commit/11a238fcaee83e35620a307f4e36d72cdf554440))
* **test:** stop the TCP port race failing CI on loaded runners ([deb14b2](https://github.com/htool/canboat/commit/deb14b2a927f5e5f874c764a1f0720725c9dd672))
* **test:** stop the TCP port race failing CI on loaded runners ([7feb89c](https://github.com/htool/canboat/commit/7feb89c5e034a506535ba3606553a70817cc5ad8))
* treat an all-ones DECIMAL as not available ([56b5bab](https://github.com/htool/canboat/commit/56b5bab1d8c25fab60c301f09217cfda5d5104bf))
* treat ESC as an escape byte only in .ebl files ([#431](https://github.com/htool/canboat/issues/431)) ([#659](https://github.com/htool/canboat/issues/659)) ([2bc71c2](https://github.com/htool/canboat/commit/2bc71c234140bc96ea5de458e2b54e093f382398))
* update stale external documentation URLs ([8e8004d](https://github.com/htool/canboat/commit/8e8004dc1b8daef060d8804492fea76549b587d8))
* update stale external documentation URLs ([0a343b6](https://github.com/htool/canboat/commit/0a343b617a1ec2df5cb1f65b084d46c78f1d2b94))
* update status flags for 24 standard PGNs confirmed by MConnect ([eb741bf](https://github.com/htool/canboat/commit/eb741bfc6348522bfcddcbd40dcd7fa98abf8406))


### Changed

* **analyzer:** give match fields a real member, not a "=275" unit string ([0313398](https://github.com/htool/canboat/commit/03133988efef78937f2b5d2ab7117ed8ab23c9ab))
* **keel:** nest repeating fieldsets under a repeat: block in YAML ([2ed2f93](https://github.com/htool/canboat/commit/2ed2f93e254c0dc3a58cc4ccb8001573fb119c15))
* **keel:** port durable tool to Rust; Python demoted to bootstrap/ ([16baee5](https://github.com/htool/canboat/commit/16baee573814f4903f73b82cddf2a7ef0edc28b9))
* remove the C n2kd and n2kd_monitor ([c5c29ea](https://github.com/htool/canboat/commit/c5c29ea86806d3550114f96ab35fcdc311d63de2))
* rename CAMEL macro to ID_AND_NAME ([#526](https://github.com/htool/canboat/issues/526)) ([#670](https://github.com/htool/canboat/issues/670)) ([a4fd69a](https://github.com/htool/canboat/commit/a4fd69a57e91a5f55c35485a4771d55824b0a450))
* **rust:** drop canboat-wire, the binary port and the wire API ([78ad505](https://github.com/htool/canboat/commit/78ad50515397db4a2df0b3487c68ef4f21b6efb5))
* **rust:** move the Cargo workspace to the repo root ([9e9b987](https://github.com/htool/canboat/commit/9e9b98720d743f283a6907575d3c1201d63dd0ac))
* **socketcan:** fragment fast-packet TX through the shared helper ([#809](https://github.com/htool/canboat/issues/809)) ([d3b3fbf](https://github.com/htool/canboat/commit/d3b3fbf78eeb54e8a205ee94f517071d2124802f))


### Internal

* release 8.0.0 as 8.0.0-beta1 ([5448998](https://github.com/htool/canboat/commit/5448998bbb506cfb18876cb7a7c71ab088ade8a0))
* release 8.1.0-beta2 as 8.0.0-beta3 ([8c11316](https://github.com/htool/canboat/commit/8c11316b71f1b13fbc56e1715f92ae31b7da38c3))
* release 8.1.0-beta3 as 8.0.0 ([#857](https://github.com/htool/canboat/issues/857)) ([c44541c](https://github.com/htool/canboat/commit/c44541c7d779f74cc194e4afcc3cf51172132bbf))
* release 9.0.0-beta1 as 8.0.0-beta2 ([1c1dfdd](https://github.com/htool/canboat/commit/1c1dfdda8e1e333fa41b57501682f2b33cfa7aa1))
